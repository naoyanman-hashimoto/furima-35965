class User < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :kana_first_name, format: { with: valid_name_kana_regex, message: 'is invalid. Input full-width katakana characters.' }
    validates :kana_last_name, format: { with:  valid_name_kana_regex, message: 'is invalid. Input full-width katakana characters.' }
    validates :birthday
  end
end
